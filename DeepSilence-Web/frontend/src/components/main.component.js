    ...
    return (
      <div className="main-wrapper">
        <div className="main-inner">
          <h2>DeepSilence</h2>
          <h5>Adversarial attack against novel DeepSpeech2 ASR system</h5>
          <p><a href="http://proceedings.mlr.press/v48/amodei16.html" className="pantoneZOZ1a">Deep Speech 2</a> is a modern ASR system, which enables end-to-end training as spectrogram is directly utilized to generate predicted sentence. In this work, IAP (Iterative Adversarial perturbation) and FAPG (Fast Adversarial perturbation generation) algorithms are implemented to conduct adversarial attack against this ASR system.</p>
