...
if __name__ == "__main__":
    ...
    attacker = UniversalAttacker(model=model, data_loader=data_loader, target=target_sentence, decoder=decoder, spect_parser=spect_parser, device=args.device, save=output_wav, resume=args.resume)

    attacker.attack(epsilon = args.epsilon, alpha=args.alpha, attack_type=args.mode, num_iteration=args.num_iters, batch=False, optimization=None, vad=True)
